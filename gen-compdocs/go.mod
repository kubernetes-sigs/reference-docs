...
require (
	...
	k8s.io/cri-api v0.23.0 // indirect
	k8s.io/kube-aggregator v0.23.0 // indirect
	k8s.io/kube-controller-manager v0.23.0 // indirect
	k8s.io/kube-proxy v0.23.0 // indirect
	...
	k8s.io/pod-security-admission v0.23.0 // indirect
)
...
// This replacement assumes that "reference-docs" is checked out one level
// *below* "kubernetes". Something like this:
// /tmp/k8s.io/kubernetes/...
// /tmp/somedir/sigs.k8s.io/reference-docs/...
replace k8s.io/kubernetes => ../../../../k8s.io/kubernetes
