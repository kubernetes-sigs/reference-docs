WEBROOT=/home/stevepe/src/github.com/kubernetes/website
K8SROOT=/home/stevepe/src/github.com/kubernetes/kubernetes
MINOR_VERSION=9
...
copycli:
	cp $(CLISRC)/index.html $(CLIDST)/kubectl-commands.html
	cp $(CLISRC)/navData.js $(CLIDST)/navData.js
